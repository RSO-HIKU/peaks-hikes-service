...
CREATE TRIGGER trg_peak_insert
AFTER INSERT ON peaks_hikes_service.peaks
FOR EACH ROW EXECUTE FUNCTION trg_peak_insert_link();
...
CREATE TRIGGER trg_trail_insert
AFTER INSERT ON peaks_hikes_service.trails
FOR EACH ROW EXECUTE FUNCTION trg_trail_insert_link();