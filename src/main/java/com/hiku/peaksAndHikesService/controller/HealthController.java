 ...
 * 
 * Endpoints:
 * - /api/peaks-hikes/health        - Overall health status with detailed checks
 * - /api/peaks-hikes/health/live   - Liveness probe (is the service running?)
 * - /api/peaks-hikes/health/ready  - Readiness probe (is the service ready to receive traffic?)
 */
@Path("/health")
@ApplicationScoped
public class HealthController {
    ...
    public Response health() {
        ...
        JsonObject healthResponse = Json.createObjectBuilder()
                .add("status", status)
                .add("service", "peaks-hikes-service")
